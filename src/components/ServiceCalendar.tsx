...
export default function ServiceCalendar({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!selectedDay || !selectedSlot || !customerName || !customerPhone)
      return;
      ...
      <div className="fixed inset-0 z-40 bg-black/50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl border-t-8 border-red-600 text-center relative">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">
            షెడ్యూలింగ్ తాత్కాలికంగా నిలిపివేయబడింది
          </h3>
          <p className="text-sm font-semibold text-red-600 mb-1">
            Scheduling Temporarily Unavailable
          </p>
          <p className="text-gray-600 text-xs">
            అడ్మిన్ ద్వారా ఈ సర్వీస్ క్యాలెండర్ ప్రస్తుతం ఆఫ్ చేయబడింది. దయచేసి
  ...
  return (
    <div className="fixed inset-0 z-40 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
      <div
        className={`bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden transition-all duration-300 relative ${
          isUpgraded
            ? "border-4 border-[#FFC000] ring-4 ring-[#FFC000]/20"
        ...
        <div className="bg-[#2563eb] text-white px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="text-[#FFC000] hover:text-white rounded-full p-1 hover:bg-white/10"
            >
        ...
        {showVault ? (
          ...
          <div className="p-8 text-center">
            ...
            <div className="my-6 p-4 bg-gray-50 rounded-xl text-left text-sm space-y-2 border border-gray-100">
              <div>
                <strong className="text-gray-500">సర్వీస్ / Service:</strong>{" "}
                {service.nameTe}
              </div>
              <div>
                <strong className="text-gray-500">తేదీ / Date:</strong> July{" "}
                {selectedDay}, 2026
              </div>
              <div>
                <strong className="text-gray-500">సమయం / Slot:</strong>{" "}
                {selectedSlot === "morning"
                  ? "ఉదయం / Morning"
                  : "మధ్యాహ్నం / Afternoon"}
              </div>
              <div>
                <strong className="text-gray-500">ధర / Base Price:</strong> ₹
                {service.basePrice}
              </div>
            </div>
            ...
            <button
              onClick={onClose}
              className="px-6 py-2 bg-[#2563eb] text-[#FFC000] font-bold rounded-lg hover:bg-[#2563eb]/90 transition"
            >
              సరే / Done
            </button>
          </div>
                    ...
                    <button
                      ...
                      className={`h-9 rounded-lg flex flex-col items-center justify-center relative font-bold text-sm transition-all ${
                        booked
                          ...
                          : isSelected
                            ? "bg-[#2563eb] text-white ring-2 ring-[#FFC000]"
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#2563eb]"
                    />
                  </div>
                </div>
                <div className="space-y-1">
              ...
              <button
                ...
                className={`flex-1 py-2.5 text-sm font-bold rounded-lg text-center transition-all ${
                  ...
                  !customerPhone
                    ...
                    : isUpgraded
                      ? "bg-[#FFC000] text-[#2563eb] shadow-md shadow-[#FFC000]/20 hover:brightness-105"
                      : "bg-[#2563eb] text-[#FFC000] hover:bg-[#2563eb]/95"
                }`}
              >
