...
export default function AppGuideWalkthrough({
  onClose,
  accentColor = "blue",
}: AppGuideWalkthroughProps) {
  ...
  const pages = [
    {
      ...
      descTe:
        "మీ చుట్టుపక్కల 5KM, 10KM, లేదా 20KM పరిధిలోనే సివిల్ వర్కర్స్ (మేస్త్రీలు, కూలీలు) యొక్క లైవ్ హాజరు స్థితిని మ్యాప్ పై గుర్తించవచ్చు. వారి ఫోన్ నెంబర్ చూసి నేరుగా కాల్ చేసి మాట్లాడుకోవచ్చు.",
      descEn:
        "Locate civil workers (masons, laborers) within your 5KM, 10KM, or 20KM radius with live attendance. View their phone numbers and call them directly.",
    ...
    },
    {
      ...
      descTe:
        "కొత్తగా అప్‌గ్రేడ్ అయిన ఫోన్ కీప్యాడ్ ద్వారా మీకు కావలసిన ఛానల్ నంబర్ డయల్ చేసి, వర్కర్స్ గ్రూప్ మరియు మేస్త్రీలతో ఉచిత వాయిస్ ప్రసారం చేయండి. వాకీ-టాకీ ఆన్ చేసి మాట్లాడవచ్చు.",
      descEn:
        "Dial your desired channel number on the new phone keypad to make free group voice transmissions with workers and groups. Switch it on and enjoy seamless comms.",
    ...
    },
    {
      ...
      descTe:
        "ఎలక్ట్రీషియన్, ప్లంబర్, బిల్డింగ్ మేస్త్రీ, పెయింటర్, టైల్స్ వర్కర్ మరియు రాడ్ బెండర్ వంటి పది రకాల ప్రధాన పనులకు సంబంధించిన నమ్మకమైన నిపుణుల ప్రొఫైళ్లను చూసి సులువుగా బుక్ చేసుకోండి.",
      descEn:
        "Easily view and book verified experts across 10 specialized categories including electricians, plumbers, masons, painters, tile workers, and steel benders.",
      ...
      illustration: (
        <div className="relative w-full h-32 bg-slate-900/40 rounded-2xl border border-white/10 p-3 flex flex-col justify-center gap-2 overflow-hidden">
          <div className="grid grid-cols-5 gap-1.5 text-center">
            {["విద్యుత్", "ప్లంబర్", "మేస్త్రీ", "రంగులు", "టైల్స్"].map(
              (txt, i) => (
                <div
                  key={i}
                  className="bg-slate-800/80 border border-white/10 rounded-lg p-1 flex flex-col items-center justify-center gap-0.5"
                >
                  <div className="w-5 h-5 rounded-full bg-[#2563eb] text-[#FFC000] text-[9px] font-bold flex items-center justify-center">
                    {i + 1}
                  </div>
                  <span className="text-[7px] text-gray-300 font-bold truncate w-full">
                    {txt}
                  </span>
                </div>
              ),
    ...
    },
    {
      ...
      descTe:
        "పనివారి జీతాలు, అడ్వాన్సులు, రోజువారీ హాజరు మరియు ఖర్చులను డిజిటల్ లెడ్జర్ ద్వారా నిర్వహించండి. ప్రైవేట్ వర్కర్స్ డైరీ సేవలు పూర్తిగా సురక్షితం మరియు సులభం.",
      descEn:
        "Manage daily attendance, wages, advances, and business costs safely using the digital ledger book. Personal worker diary is fully encrypted and secure.",
      ...
      illustration: (
        <div className="relative w-full h-32 bg-slate-900/40 rounded-2xl border border-white/10 p-2.5 flex flex-col justify-between overflow-hidden">
          ...
          <div className="text-[8px] bg-[#2563eb]/40 text-blue-300 px-2 py-0.5 rounded-lg border border-blue-500/20 text-center">
    ...
    },
    {
      ...
      descTe:
        "నిర్మాణ పనులకు అవసరమైన ఇసుక, సిమెంట్, మరియు ఇటుకల మొత్తాన్ని అబాకస్ ఎస్టిమేటర్ ద్వారా ముందుగానే లెక్కించండి. ఖర్చును సరిగ్గా అంచనా వేయండి.",
      descEn:
        "Estimate the amount of sand, cement, and bricks needed for construction projects using the Abacus estimator. Accurately plan your budget.",
    ...
    },
    {
      ...
      descTe:
        "పని జరుగుతున్న తీరును పర్యవేక్షించండి. మేస్త్రీలు, కూలీల పనితీరును మరియు ప్రోగ్రెస్ ని రిపోర్టుల రూపంలో పంపండి.",
      descEn:
        "Monitor project progress. Submit performance reports for masons, laborers, and ongoing work.",
    ...
    },
    {
      ...
      descTe:
        "నిర్మాణ యంత్రాలు, కాంక్రీట్ మిక్సర్లు, మరియు క్రేన్ల మరమ్మతుల కోసం నిపుణులైన మెకానిక్లను వెతకండి మరియు సర్వీసు బుక్ చేయండి.",
      descEn:
        "Find expert mechanics for construction machinery, concrete mixers, and crane repairs. Book services instantly.",
    ...
    },
    {
      ...
      descTe:
        "అన్ని సౌకర్యాలు మీకు సిద్ధంగా ఉన్నాయి. ఇప్పుడు యాప్‌ని ఉపయోగించి మీ నిర్మాణ పనులను సులభంగా, వేగంగా మరియు భద్రంగా పూర్తి చేయండి.",
      descEn:
        "All features are ready for you. Start using the app to complete your construction work easily, quickly, and securely.",
  ...
  return (
    <div className="fixed inset-0 z-40 bg-slate-950/90 backdrop-blur-md flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-[#2563eb] text-white p-4 border-b border-white/10 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-xs font-black tracking-wider uppercase text-white">
                స్క్రీన్ గైడ్ / App Guide
              </h2>
              <p className="text-[8px] text-[#FFC000] font-bold">
                స్టెప్ బై స్టెప్ స్క్రీన్ల వివరణ
              </p>
            </div>
          </div>
          <button
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h3 className="text-white font-black text-sm mt-0.5">
                    {currentPageData.titleTe}
                  </h3>
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4.5 py-2.5 rounded-xl font-black text-[11px] transition shadow-md active:scale-95 cursor-pointer ${
              currentPage === pages.length
                ...
                : "bg-[#FFC000] text-[#2563eb] hover:bg-[#ffe060] shadow-[#FFC000]/10"
            }`}
          >
            {currentPage === pages.length ? (
              <>
