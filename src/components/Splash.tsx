...
export default function Splash({
  ...
  return (
    <div
      id="cwb-splash-screen"
      className="fixed inset-0 z-50 bg-[#072459] flex flex-col items-center justify-center overflow-y-auto py-8 px-4"
    >
      ...
      <div className="w-full flex flex-col items-center justify-center z-10 flex-1">
        ...
        <div className="text-center px-4 w-full mt-4">
          <h1
            className="text-[#FFC000] text-2xl md:text-3xl font-bold tracking-wide"
      ...
      <div className="w-full max-w-sm z-10 flex flex-col justify-center mb-10">
        {!isLoggedIn ? (
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-[#FFC000] text-xs font-bold font-mono">
              పోర్టల్ లోనికి ప్రవేశిస్తున్నారు...
            </p>
          </div>
        )}
      </div>
