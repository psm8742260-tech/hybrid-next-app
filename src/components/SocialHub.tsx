...
export default function SocialHub({
  ...
  const [posts, setPosts] = useState<SocialPost[]>([
    {
      ...
      description:
        "ఇంట్లో వైరింగ్ మరియు స్విచ్ బోర్డు రిపేర్ కోసం అనుభవజ్ఞుడైన ఎలక్ట్రీషియన్ అర్జంటుగా కావాలి.",
      phone: "9848032910",
    ...
    },
    {
      ...
      description:
        "అన్ని రకాల ఇటుకల పని, ప్లాస్టరింగ్ మరియు కన్స్ట్రక్షన్ పనులు అనుభవంతో అతి తక్కువ ధరలో చేయబడును.",
      phone: "9123456789",
    ...
    },
    {
      ...
      description:
        "ఇంట్లో బాత్‌రూమ్ టాప్స్ మరియు పైపులైన్ లీకేజ్ రిపేర్ పనులు ఉన్నాయి. అర్జంటుగా రావాలి.",
      phone: "8765432109",
  ...
  const [postType, setPostType] = useState<"wanted" | "available" | "general">(
    "wanted",
  );
  ...
  // Sharing Popup state
  const [activeSharingPost, setActiveSharingPost] = useState<SocialPost | null>(
    null,
  );
  ...
  const handleTogglePlatform = (platform: string) => {
    if (selectedSharePlatforms.includes(platform)) {
      setSelectedSharePlatforms(
        selectedSharePlatforms.filter((p) => p !== platform),
      );
    } else {
    ...
    return (
      <div className="bg-slate-50 border border-gray-150 p-6 rounded-2xl text-center text-xs text-gray-500 space-y-2">
        ...
        <p className="font-extrabold text-gray-800">
          సామాజిక మాధ్యమాల వేదిక నిలిపివేయబడింది
        </p>
        <p className="text-[10px] text-gray-400">
          Social Media Hub Suspended by Master Admin
        </p>
      </div>
    );
  }
    ...
    >
      ...
      <div className="bg-[#2563eb] text-white p-3.5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h4 className="font-black text-xs">
              సామాజిక మాధ్యమాలు & షేరింగ్ (Social Hub)
            </h4>
            <p className="text-[9px] text-gray-300">
              వాట్సాప్, ఫేస్‌బుక్ గ్రూప్స్ షేరింగ్ బోర్డు
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="bg-[#FFC000] text-[#2563eb] px-3 py-1 rounded-lg text-[10px] font-black flex items-center gap-1 active:scale-95 transition-all shadow-sm"
        >
          ...
          >
            <form onSubmit={handleCreatePost} className="space-y-3">
                    ...
                    return (
                      <button
                        ...
                        className={`p-2.5 rounded-full text-white transition relative ${p.color} ${
                          active
                            ? "scale-110 ring-2 ring-offset-2 ring-[#2563eb]"
                            : "opacity-40 scale-90"
                        }`}
                      >
                        {p.icon}
              ...
              <div className="flex gap-2.5 pt-1">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2 bg-[#2563eb] text-white font-extrabold rounded-lg hover:bg-[#001040]"
                >
                  పోస్ట్ & షేర్ / Submit
                </button>
              </div>
      ...
      <div className="p-3 bg-slate-50/50 space-y-2.5">
        <div className="flex items-center justify-between">
          <span className="text-[10px] font-black text-gray-500 uppercase">
            సామాజిక ఫీడ్ (Active Social Feed)
          </span>
          <span className="text-[8px] bg-blue-100 text-[#2563eb] font-black px-1.5 py-0.5 rounded font-mono">
        ...
        <div className="space-y-2.5 max-h-[290px] overflow-y-auto pr-0.5">
          {posts.map((post) => {
            ...
            return (
              <div
                key={post.id}
                className="bg-white p-3 rounded-xl border border-gray-100 space-y-2 shadow-xs transition hover:border-[#2563eb]/30"
              >
                <div className="flex justify-between items-start">
                  <div>
                    <span
                      className={`text-[8px] font-black px-1.5 py-0.5 rounded-sm mr-1.5 ${
                        isWanted
                ...
                <div className="pt-1.5 border-t border-dashed border-gray-100 flex items-center justify-between text-[10px] text-gray-500">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="px-2 py-1 bg-slate-100 hover:bg-[#2563eb] text-gray-700 hover:text-white transition-all font-black text-[9px] rounded-lg flex items-center gap-0.5"
                    >
            ...
            >
              <div className="text-center space-y-2 mb-4">
                ...
                <h3 className="text-sm font-black text-[#FFC000]">
                  {sharingPlatform === "all"
                    ? "సర్వీస్ కార్డును షేర్ చేయండి"
                    : `${sharingPlatform.toUpperCase()} షేరింగ్ ఇంటెంట్`}
                </h3>
                <p className="text-[10px] text-gray-400">
                  Social sharing automated generation engine
                </p>
              </div>
              ...
              <div className="space-y-1.5 mb-4">
                <label className="text-[9px] font-bold text-gray-400 block uppercase">
                  లింక్ మరియు మెసేజ్ కాపీ టెక్స్ట్:
                </label>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  <button
                    onClick={() => {
                      ...
                      alert(
                        "మెసేజ్ క్లిప్‌బోర్డ్‌కు కాపీ చేయబడింది! (Copied to Clipboard!)",
                      );
                    }}
                  ...
                  <button
                    onClick={() =>
                      triggerRealShare(activeSharingPost, sharingPlatform)
                    }
