...
import { MessageSquare, X, Send, Bot, Mic, Upload, FileText, Sparkles, ShieldAlert, Key, Volume2, VolumeX, Paperclip, FileCheck } from 'lucide-react';
...
const BRAHMASTRA_AGENTS = [
  { id: 'default', label: '👤 సాధారణ అసిస్టెంట్', color: 'bg-slate-100 text-slate-800', welcome: 'నమస్కారం! నేను సాధారణ సహాయక ఏజెంట్‌ను. మీకు ఏ సమాచారం కావాలి? కింద టైప్ చేయండి లేదా అడగండి.', category: 'general' },
  
  // AI Powers
  { id: 'kings_gemini', label: '💎 జెమిని AI ఏజెంట్', color: 'bg-indigo-50 text-indigo-800', welcome: 'నమస్కారం! నేను గూగుల్ జెమిని (Gemini AI) ఏజెంట్‌ను. మీ కోడింగ్, సమాచార విశ్లేషణ, మరియు సాంకేతిక సహాయం అందించడానికి సిద్ధంగా ఉన్నాను.', category: 'kings' },
  { id: 'kings_google', label: '🔍 గూగుల్ సెర్చ్ ఏజెంట్', color: 'bg-sky-50 text-sky-800', welcome: 'నమస్కారం! నేను గూగుల్ సెర్చ్ (Google Web AI) ఏజెంట్‌ను. అత్యంత ఖచ్చితమైన సమాచారం, వెబ్ ఫ్యాక్ట్స్ మరియు వివరాలను అందించడానికి సిద్ధంగా ఉన్నాను.', category: 'kings' },
  { id: 'kings_chatgpt', label: '💬 చాట్‌జిపిటి AI ఏజెంట్', color: 'bg-emerald-50 text-emerald-800', welcome: 'నమస్కారం! నేను చాట్‌జిపిటి (ChatGPT AI) ఏజెంట్‌ను. మీ సృజనాత్మక ఆలోచనలు, అందమైన ఫార్మాటింగ్ మరియు అద్భుతమైన సలహాలతో మీకు సహాయపడటానికి సిద్ధంగా ఉన్నాను.', category: 'kings' },
  { id: 'kings_meta', label: '🦙 లామా AI ఏజెంట్', color: 'bg-purple-50 text-purple-800', welcome: 'నమస్కారం! నేను లామా (Llama AI) ఏజెంట్‌ను. ఓపెన్-సోర్స్ పవర్, టెక్నికల్ సలహాలు మరియు పటిష్టమైన సమాచారంతో సాయం చేయడానికి సిద్ధంగా ఉన్నాను.', category: 'kings' },
  { id: 'kings', label: '🤖 క్లాడ్ AI ఏజెంట్', color: 'bg-amber-50 text-amber-800', welcome: 'నమస్కారం! నేను క్లాడ్ (Claude AI) ఏజెంట్‌ను. డెవలపర్ లాజికల్ గైడెన్స్, రీసెర్చ్ మరియు అద్భుతమైన విశ్లేషణ సామర్థ్యాలతో సహాయం అందించడానికి సిద్ధంగా ఉన్నాను.', category: 'kings' },
  
  // Specialized Web & Logic Agents
  { id: 'ministers', label: '🧠 అనలిటికల్ థింకింగ్ ఏజెంట్', color: 'bg-yellow-50 text-yellow-800', welcome: 'నమస్కారం! నేను అనలిటికల్ థింకింగ్ (Analytical Expert) ఏజెంట్‌ను. క్లిష్టమైన సమస్యలను విశ్లేషించి, వ్యూహాత్మక పరిష్కారాలు అందించడానికి సిద్ధం.', category: 'council' },
  { id: 'commanders', label: '⚡ ఫాస్ట్ రెస్పాన్స్ ఏజెంట్', color: 'bg-orange-50 text-orange-800', welcome: 'నమస్కారం! నేను ఫాస్ట్ రెస్పాన్స్ (Quick Action) ఏజెంట్‌ను. మీ సందేహాలకు అతి త్వరగా, సూటిగా మరియు ప్రెసిషన్ తో సమాధానమిస్తాను.', category: 'council' },
  { id: 'soldiers', label: '🛡️ డేటా ప్రైవసీ రక్షణ ఏజెంట్', color: 'bg-zinc-50 text-zinc-800', welcome: 'నమస్కారం! నేను డేటా ప్రైవసీ రక్షణ (Data Privacy Guard) ఏజెంట్‌ను. మీ సమాచార భద్రత మరియు సురక్షిత సంభాషణలను పర్యవేక్షించడానికి నేను సిద్ధంగా ఉన్నాను.', category: 'council' },

  // App Dev AI Agents
  { id: 'dev_builder', label: '🛠️ బిల్డర్ ఏజెంట్', color: 'bg-emerald-50 text-emerald-800', welcome: 'యాప్ నిర్మాణ శిల్పి: నమస్కారం! నేను మీ బ్రహ్మాస్త్ర యాప్ బిల్డర్ ఏజెంట్‌ను. అప్లికేషన్ స్ట్రక్చర్, లేఅవుట్ మరియు కాంపోనెంట్స్ డిజైన్ చేయడంలో మీకు ఏ సాయం కావాలి?', category: 'dev' },
  { id: 'dev_color', label: '🎨 కలర్ కోడర్', color: 'bg-amber-50 text-amber-800', welcome: 'కలర్ కోడింగ్ శిల్పి: నమస్కారం! నేను మీ UI/UX కలర్ అసిస్టెంట్‌ను. యాప్ రంగులు, థీమ్స్ మరియు బ్యాక్‌గ్రౌండ్ గ్రేడియంట్స్ ఎంచుకోవడంలో మీకు ఎలా సహాయపడాలి?', category: 'dev' },
  { id: 'dev_design', label: '📐 UI/UX డిజైనర్', color: 'bg-blue-50 text-blue-800', welcome: 'UI/UX డిజైనర్: నమస్కారం! యాప్ లోని బటన్లు, స్పేసింగ్, గ్రిడ్స్ మరియు అలైన్‌మెంట్ల డిజైన్ గురించి మనం చర్చిద్దాం. మీకు ఎలా సహాయపడాలి?', category: 'dev' },
  { id: 'dev_database', label: '🗄️ డేటాబేస్ ఏజెంట్', color: 'bg-indigo-50 text-indigo-800', welcome: 'డేటాబేస్ అసిస్టెంట్: నమస్కారం! ఫైర్‌స్టోర్ స్కీమాలు, సెక్యూరిటీ రూల్స్ మరియు డేటా స్టోరేజ్ పర్సిస్టెన్స్ గురించి మీకు ఏ సమాచారం కావాలి?', category: 'dev' },
  { id: 'dev_audio', label: '🔔 సౌండ్ ఇంజనీర్', color: 'bg-purple-50 text-purple-800', welcome: 'మీడియా సింథసైజర్: నమస్కారం! టెక్స్ట్-టు-స్పీచ్, సిగ్నల్ టోన్స్ మరియు అలర్ట్ సౌండ్స్ గురించి మీకు ఏ వివరణ కావాలి?', category: 'dev' },
  { id: 'dev_security', label: '🛡️ సెక్యూరిటీ ఏజెంట్', color: 'bg-rose-50 text-rose-800', welcome: 'సెక్యూరిటీ ఆఫీసర్: నమస్కారం! API కీలు, వెబ్‌హుక్స్, ఎన్‌క్రిప్షన్ మరియు రక్షణ కవచం (Zero-Leak Shield) భద్రత గురించి చర్చించడానికి నేను సిద్ధం.', category: 'dev' },
  { id: 'dev_tester', label: '🚀 బిల్డ్ టెస్టర్', color: 'bg-teal-50 text-teal-800', welcome: 'క్వాలిటీ టెస్టర్: నమస్కారం! యాప్ కంపైలేషన్, బిల్డ్ టెస్టింగ్, మరియు టైప్‌స్క్రిప్ట్ ఎర్రర్ నివారణ గురించి మీకు ఏ సాంకేతిక సహాయం కావాలి?', category: 'dev' }
];
...
export default function ChatAssistant({ 
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', text: 'నమస్కారం! నేను CWRB AI అసిస్టెంట్ బోర్డు. మీకు ఏ సమాచారం కావాలి? కింద టైప్ చేయండి లేదా అడగండి.' }
  ]);
  ...
  const [agentTab, setAgentTab] = useState<'standard' | 'brahmastra_100'>('standard');
  ...
  const filtered100Agents = useMemo(() => {
    ...
    for (let i = 1; i <= 100; i++) {
      ...
      if (!searchLower) {
        ...
        const matchesSpecialty = agent.specialty?.toLowerCase().includes(searchLower);
  ...
  const speakText = (text: string, index: number) => {
    try {
      ...
      const teVoice = voices.find(v => v.lang.startsWith('te') || v.lang.includes('TELUGU') || v.lang.includes('Telugu'));
      if (teVoice) {
  ...
  const handleSelectAgent = (agentId: string) => {
    if (agentId === 'default') {
      ...
      setMessages(prev => [
        ...prev,
        { role: 'assistant', text: `✨ [ఏజెంట్ మార్పిడి] సాధారణ AI అసిస్టెంట్ తిరిగి కనెక్ట్ చేయబడ్డారు.` },
        { role: 'assistant', text: 'నమస్కారం! నేను CWRB AI అసిస్టెంట్ బోర్డు. మీకు ఏ సమాచారం కావాలి? కింద టైప్ చేయండి లేదా అడగండి.' }
      ]);
      return;
    }
  ...
  const handleVerifyCode = () => {
    ...
    const savedPwd = localStorage.getItem('cwb_brahmastra_pwd')?.trim().toUpperCase();
    
    const isCustomMatch = savedPwd && cleanCode === savedPwd;
    const isDefaultMatch = cleanCode === 'CWRB99' || cleanCode === 'BRAHMASTRA' || cleanCode === 'ADMIN123' || cleanCode === 'CWRB';

    if (isCustomMatch || (!savedPwd && isDefaultMatch) || (savedPwd && isDefaultMatch && savedPwd === '')) {
      if (targetAgentId) {
        ...
        if (selected) {
          setMessages(prev => [
            ...prev,
            { role: 'assistant', text: `🔑 [ధృవీకరణ విజయం] సీక్రెట్ కోడ్ విజయవంతంగా సరిపోలింది. అడ్మిన్ యాక్సెస్ లభించింది!` },
            { role: 'assistant', text: `✨ [ఏజెంట్ కనెక్ట్] ${selected.label} ఇప్పుడు అందుబాటులోకి వచ్చారు.` },
      ...
      setCodeError('సరికాని సీక్రెట్ కోడ్! దయచేసి సరైన పాస్‌కోడ్ నమోదు చేయండి.');
    }
  };
  ...
  const handleSend = async (customMessage?: string) => {
    ...
    try {
      ...
      const finalMessage = textToSend.trim() || `నేను మీకు ఈ ఫైల్/ఫోటోని పంపించాను: ${filePayload?.name}. దయచేసి దీన్ని పరిశీలించి నాకు తెలుగులో సహాయం అందించండి.`;

      const response = await fetch('/api/chat', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
          boardId: activeBoardId, deepseekApiKey: localStorage.getItem('cwb_deepseek_api_key'), 
      ...
      setMessages(prev => [...prev, { role: 'assistant', text: 'క్షమించండి, ప్రస్తుతం సేవలు అందుబాటులో లేవు.' }]);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#082c75] text-white p-3 shrink-0">
        <div className="flex justify-between items-center mb-1">
          <div className="flex items-center gap-1.5">
            <Bot size={16} className="text-[#FFC000] animate-bounce" />
            <span className="font-extrabold text-xs">CWRB AI అసిస్టెంట్ బోర్డు</span>
          </div>
          <div className="flex items-center gap-1.5">
            <button
              onClick={() => setAutoSpeak(!autoSpeak)}
              className={`p-1.5 rounded-lg transition ${
                autoSpeak ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30' : 'bg-slate-800 text-slate-400 border border-slate-700'
              }`}
              title={autoSpeak ? "ఆటో వాయిస్ ఆన్ (Auto-Speak is ON)" : "ఆటో వాయిస్ ఆఫ్ (Auto-Speak is OFF)"}
            >
              {autoSpeak ? <Volume2 size={11} className="animate-pulse" /> : <VolumeX size={11} />}
            </button>

            <span className="text-[8px] bg-emerald-500 text-white px-1.5 py-0.5 rounded font-black font-mono">LIVE</span>
          </div>
        </div>

        {/* Agent Toggles Bar */}
        {isSystemOnline && (
          <div className="bg-[#00184a] px-3 py-2 flex justify-between items-center shrink-0 border-t border-white/10 gap-2">
            ...
            <button 
              ...
              className={`flex-1 py-1.5 rounded-lg text-[10px] font-black transition cursor-pointer border flex items-center justify-center gap-1.5 ${
            ...
            >
              👤 సాధారణ ఏజెంట్ - {selectedAgent === 'default' ? 'ON' : 'OFF'}
            </button>
            ...
            {isBrahmastraButtonVisible && (
              ...
              >
                <Sparkles size={12} /> బ్రహ్మాస్త్రం ఏజెంట్ - {(selectedAgent !== 'default' && selectedAgent !== 'none') ? 'ON' : 'OFF'}
              </button>
            )}
          </div>
        )}
      ...
      {(isSystemOnline && showAgentList) && (
        <div className="absolute inset-x-0 top-[40px] bottom-0 bg-white z-50 p-3 flex flex-col overflow-y-auto border-t border-gray-150">
          <div className="flex justify-between items-center mb-2 shrink-0">
            <span className="font-black text-xs text-[#082c75] flex items-center gap-1">
          ...
          <p className="text-[9px] text-gray-500 font-bold mb-3 leading-tight shrink-0">
            బ్రహ్మాస్త్రంలోని ఏ ఏజెంట్‌తోనైనా మాట్లాడటానికి కింద వారిని ఎంచుకోండి. వారు ఈ చాట్ లోకి వస్తారు. (సీక్రెట్ కోడ్ అవసరం)
          </p>
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex gap-1.5">
                    <button
                      ...
                      className={`flex-1 p-2 rounded-xl text-left border transition active:scale-97 cursor-pointer flex items-center justify-between gap-2 ${
                        selectedAgent === 'default'
                          ? 'border-[#082c75] bg-[#082c75]/5 text-[#082c75]'
                          : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'
                      }`}
                    >
                      <div className="flex flex-col">
                        <span className="text-[10px] font-black">👤 సాధారణ అసిస్టెంట్ (Ordinary Assistant)</span>
                        <span className="text-[8px] text-gray-400 mt-1 font-semibold leading-relaxed">
                          నమస్కారం! నేను సాధారణ సహాయక ఏజెంట్‌ను. మీకు ఏ సమాచారం కావాలి?
                        </span>
                      </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {BRAHMASTRA_AGENTS.filter(a => a.category === 'kings').map((agent) => (
                      <button
                        key={agent.id}
                      ...
                      >
                        <span className="text-[10px] font-black">{agent.label}</span>
                        <span className="text-[8px] text-gray-400 mt-1 line-clamp-2 font-medium">
                          {agent.welcome.split('!').slice(1).join('!') || agent.welcome}
                        </span>
                      </button>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {BRAHMASTRA_AGENTS.filter(a => a.category === 'council').map((agent) => (
                      <button
                        key={agent.id}
                        onClick={() => handleSelectAgent(agent.id)}
                        className={`p-2 rounded-xl text-left border transition active:scale-97 cursor-pointer flex flex-col justify-between ${
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {BRAHMASTRA_AGENTS.filter(a => a.category === 'dev').map((agent) => (
                      <button
                        key={agent.id}
                        onClick={() => handleSelectAgent(agent.id)}
                        className={`p-2 rounded-xl text-left border transition active:scale-97 cursor-pointer flex flex-col justify-between ${
                ...
                <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-150 space-y-2 shrink-0">
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white border border-gray-200 rounded-lg px-2.5 py-1.5 text-[10px] font-semibold focus:outline-none focus:ring-1 focus:ring-[#082c75]"
                    />
                    {agentSearch && (
                      <button
                  ...
                  <div className="flex items-center gap-1.5 text-[10px] font-black text-gray-600">
                    ...
                    <input
                      ...
                      className="w-16 bg-white border border-gray-200 rounded-lg px-1.5 py-0.5 text-center focus:outline-none focus:ring-1 focus:ring-[#082c75] text-[10px] font-bold"
                    />
                    <button
                      onClick={() => {
                      ...
                      className="bg-[#082c75] hover:bg-[#001040] text-white px-2.5 py-0.5 rounded-md font-extrabold text-[9px] transition active:scale-95 cursor-pointer"
                    >
                      సమన్ ⚡
                    </button>
                    <button
                  ...
                  <>
                    <div className="grid grid-cols-2 gap-1.5">
                      {paginated100Agents.map((agent) => (
                        ...
                        >
                          <div>
                            <span className="text-[10px] font-black text-slate-800 line-clamp-1">{agent.label}</span>
                          </div>
                    ...
                    {totalPages > 1 && (
                      <div className="flex justify-between items-center mt-3 pt-3 border-t border-gray-100 shrink-0">
                        ...
                        <span className="text-[9px] font-black text-gray-500">
                          పేజీ {agentPage} / {totalPages} (మొత్తం {filtered100Agents.length})
                        </span>
                        <button
                          onClick={() => setAgentPage(p => Math.min(totalPages, p + 1))}
          ...
          <div className="w-full max-w-xs text-center space-y-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[9px] text-slate-400 font-bold leading-tight">
                బ్రహ్మాస్త్ర ఏజెంట్‌ను సమన్ చేయడానికి సీక్రెట్ కోడ్ నమోదు చేయండి.
              </p>
            </div>
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-3.5 space-y-3 bg-gray-50/50">
        {messages.map((m, i) => (
          <div 
            key={i} 
          ...
          >
              ...
              <div className="mb-1 rounded-xl overflow-hidden border border-gray-150 max-w-[180px] bg-white shadow-2xs">
                {m.file.type.startsWith('image/') ? (
                  <img loading="lazy" decoding="async" 
                    ...
                    onClick={() => {
                      const w = window.open();
                      if (w) w.document.write(`<img loading="lazy" decoding="async" src="${m.file?.base64}" style="max-width:100%; max-height:100vh; display:block; margin:auto; padding:20px;" />`);
                    }}
                  />
                ) : (
                  <div className="p-2 flex items-center gap-1.5 text-[9px] font-black text-gray-700 bg-gray-50">
                    <FileText size={12} className="text-[#082c75] shrink-0" />
            ...
            <div className={`text-[11px] p-2.5 rounded-2xl leading-relaxed font-semibold shadow-2xs flex items-start gap-1.5 group relative ${
              m.role === 'user' 
                ? 'bg-[#082c75] text-white rounded-tr-none' 
              ...
              <button
                ...
                className={`p-0.5 rounded transition shrink-0 ${
                  m.role === 'user' 
                    ...
                    : 'text-gray-400 hover:text-[#082c75] hover:bg-gray-100'
                }`}
                title="వాయిస్ వినండి"
              >
                <Volume2 size={11} className={speakingIndex === i ? "text-amber-500 animate-bounce" : ""} />
              </button>
            </div>
          </div>
        ))}
      ...
      <div className="px-3 py-1.5 bg-white border-t border-gray-100 flex gap-1.5 overflow-x-auto shrink-0 select-none no-scrollbar">
        {PRESET_CHIPS.map((chip, idx) => (
          <button
            ...
            disabled={isLoading}
            className="shrink-0 bg-[#082c75]/5 hover:bg-[#082c75]/10 border border-[#082c75]/10 text-[#082c75] px-2.5 py-1 rounded-full text-[9px] font-bold transition active:scale-95 disabled:opacity-50 cursor-pointer"
          >
            {chip.textTe}
          </button>
        ))}
      ...
      {attachedFile && (
        <div className="px-3 py-1.5 bg-amber-50/70 border-t border-amber-100 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] font-black text-slate-700 truncate max-w-[180px]">{attachedFile.name}</span>
              <span className="text-[7px] text-slate-400 font-bold">{(attachedFile.size / 1024).toFixed(1)} KB</span>
            </div>
          </div>
          <button 
